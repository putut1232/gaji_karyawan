        ...
        <div class="page-container">
            ...
            <div class="page-sidebar" id="sidebar">
                ...
                <div class="sidebar-header-wrapper">
                    ...
                    <div class="searchhelper">Search Anytings</div>
                </div>
                <!-- /Page Sidebar Header -->
                <!-- Sidebar Menu -->
                <ul class="nav sidebar-menu">
                    ...
                    <li>
                        <a href="index.php?p=inputgaji">
                            <i class="menu-icon fa fa-pencil-square-o"></i>
                            <span class="menu-text"> Form Gaji </span>
                        </a>
                    </li>
                    <li>
                        <a href="index.php?p=datagaji">
...
<div class="page-content">
    ...
    <div class="page-breadcrumbs">
        <ul class="breadcrumb">
            <li class="active">Aplikasi Penggajian Karyawan</li>
        </ul>
    </div>
    <!-- /Page Breadcrumb -->
    <!-- Page Header -->
